  ...
  return (
    <>
      <div className="mb-8">
        ...
        <h1 className="font-serif text-3xl text-[#E2E8F0] mb-1">Create account</h1>
        <p className="text-sm text-[#475569]">Start qualifying leads with AI</p>
      </div>
      ...
      <p className="mt-6 text-center text-xs text-[#475569] font-mono">
        ...
        <Link href="/login" className="text-[#64748B] hover:text-[#CBD5E1] transition-colors underline underline-offset-2">
          Sign in
        </Link>
      </p>
    </>
